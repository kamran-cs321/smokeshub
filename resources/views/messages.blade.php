													...
													<tbody>
													  @foreach ($messages as $message)
														...
														<tr role="row" class="odd">
                                                            ...
                                                            {{-- <td>
                                                                <a   href="#"  onclick="edit_customer_info({{ $message->id}})"  class="btn btn-success"  ><i class="fa fa-edit"></i></a>
                                                                 
															 
																 
																<button class="btn btn-danger" onclick="delete_customer({{ $message->id }},1)" type="button"><i class="fa fa-trash"></i></button>
