										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="{{url('/admin')}}" class="dropdown-item text-center user pb-0 font-weight-bold">{{ Session::get('user')->username }}</a>
												 
													<div class="dropdown-divider"></div>
												</div>
												@if(Session::get('user')->admin_id == 2)
													<a class="dropdown-item d-flex" data-toggle="modal" data-target="#CreateAdmin" href="#">
												...
												<a class="dropdown-item d-flex" data-toggle="modal" data-target="#updateinfo"   href="#">
						...
						<div class="modal" id="CreateAdmin">
							...
							<div class="modal-content">
								...
								<h4 class="modal-title" style="margin-left:40%">Create New Admin</h4>
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" name="username" placeholder="Username here" required/>
								</div>
								<div class="form-group">
									<label>Email</label>
									<input class="form-control" type="text" name="email" placeholder="Email here" required/>
								</div>
								<div class="form-group">
									<label>Password</label>
									<input class="form-control" type="password" name="password" placeholder="Password here" required/>
								</div>
								</div>
						...
						<div class="modal" id="updateinfo">
							<div class="modal-dialog">
							<div class="modal-content">
								<form id="update_password" method="POST" action="{{ url('/user/update-info') }}">
								<!-- Modal Header -->
								<div class="modal-header">
								<h4 class="modal-title" style="margin-left:40%">Update Info</h4>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								</div>
								@csrf
								<!-- Modal body -->
								...
								<div class="form-group">
									<label>Username</label>
									<input class="form-control" id="new_username" value="{{Session::get('user')->username }}" type="text" name="username" placeholder="Username here" required/>
								</div>
								<div class="form-group">
									<label>Email</label>
									<input class="form-control" id="new_email" value="{{Session::get('user')->email }}" type="text" name="email" placeholder="Email here" required/>
								</div>
								<div class="form-group">
									<label>Old Password</label>
									<input class="form-control" id="old_password" type="password" name="old_password" placeholder="Old Password here" autocomplete="off" required/>
								</div>
								<div class="form-group">
									<label>New Password</label>
									<input class="form-control" id="new_password" type="password" name="password" placeholder="New Password here" autocomplete="off" required/>
								</div>
